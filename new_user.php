...
<html lang="ES">
	...
	<body>
		...
		<div id="color" class="span6 offset4">	
		 	<span><h1>Nuevo Usuarios</h1></span>
			<form  method="post" action="crud.php" confirm>
				<b>Nombre:</b><br>
				<input type="text" name="nom" class="input-medium" MAXLENGTH="20"  required autofocus><br>
				<b>usuario:</b><br>
				<input type="text"  name="user" class="input-medium" MAXLENGTH="15"  required><br>
				<b>contraseña:</b><br>
				<input type="password" id="pass1" name="pass1" class="input-medium" MAXLENGTH="10" required ><br>
				<b>confirmar contraseña:</b><br>
				<input type="password" id="pass2" name="pass2" class="input-medium" MAXLENGTH="10"  required onBlur="veri()" ><br>
				<b>Email:</b><br>
				<input type="email" name="mail" class="input-medium" MAXLENGTH="40" required ><br>
				<b>Rol:</b><br>
		    ...
		    ?>
				...
				<input type="submit" id="crear" name="crear" value="crear" onclick="return clave()" class="btn btn-success" > 
